...
import { useSupports } from "@/ions/hooks/supports";
...
export default function StreamCard({
	...
	const supportsDisplayMedia = useSupports("navigator.mediaDevices.getDisplayMedia", "function");
	const supportsUserMedia = useSupports("navigator.mediaDevices.getUserMedia", "function");
	...
	return (
		<Card sx={{ width: "100%" }}>
			{(supportsUserMedia || supportsDisplayMedia) && (
				<>
					<CardHeader
						...
						>
							<Toolbar sx={{ display: "flex", justifyContent: "center" }}>
								<Fab
									...
									onClick={
										stream ? onStop : checked ? onShareCamera : onShareScreen
									}
								>
			...
			<CardContent>
				{supportsDisplayMedia ? (
					...
					<Typography>
						<>{t("common:noScreenSharing")}</>
					</Typography>
				)}
				{!supportsUserMedia && (
					<Typography>
						<>{t("common:noCameraSharing")}</>
					</Typography>
				)}
			</CardContent>
		</Card>
